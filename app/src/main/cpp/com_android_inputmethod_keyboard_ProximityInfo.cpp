 ...
 * See the License for the specific language governing permissions andBinaryDictionary
...
int register_ProximityInfo(JNIEnv *env) {
    const char *const kClassPathName = "com/tohsoft/keyboard/keyboard/ProximityInfo";
